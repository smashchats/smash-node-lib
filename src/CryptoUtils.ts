...
export default class CryptoUtils {
    ...
    async sha256fromObject(object: unknown, encoding: BufferEncoding = 'utf8'): Promise<string> {
        return this.sha256(this.stringToBuffer(JSON.stringify(object), encoding));
    }
